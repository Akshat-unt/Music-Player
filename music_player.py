...
statusbar = ttk.Label(root, text="Welcome to Hue Music Player", anchor=W, font='Arial 8 italic')
statusbar.pack(side=BOTTOM, fill=X)
statusbar1 = ttk.Label(root, text="Welcome to Hue Music Player", anchor=W, font='Arial 8 italic')
...
def browse_file():
    ...
    filename_path = "C:\\Users\\Karvy Distribution\\Music\\yt5s.com - KALKI MASS BGM JJ music StudioZ Jos Jossey (320 kbps).mp3"#filedialog.askopenfilename()
    ...
    if paused:
        ...
        try:
            ...
            tkinter.messagebox.showerror('File not found',
                                         'Hue music player could not find the file. Please select again.')
